...
(
	'std_error' => "哎呀，出错了",
	'std_no_such_user' => "哎呀，没有找到这个ID的用户哦！",
	'head_details_for' => "看看这个用户的详情 - ",
	'text_account_disabled_note' => "这个账号已经被禁用啦！",
	...
	'row_join_date' => "加入日期",
	'row_last_seen' => "最近活动",
	'row_last_seen_location' => "最近活动(地点)",
	'row_email' => "邮箱",
	'row_users_ips' => "IP记录",
	'row_ip_history' => "IP历史",
	'text_user_earlier_used' => "这个用户以前使用了",
	...
	'text_not_warned' => "未被警告。",
	'text_arbitrary_duration' => "(自定义时长)",
	'text_until' => "直到 ",
	'text_to_go' => "剩余时间",
	'text_warn_for' => "警告时间",
	'text_week' => "周",
	...
	'text_very_low' => "很低",
	'row_invites' => "邀请",
	'js_delete_user_note' => "如果确定，你现在可以删除这个用户。",
	'std_sorry' => "对不起",
	'std_user_not_confirmed' => "这个用户还未通过验证！",
