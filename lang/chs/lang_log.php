...
(
	'std_sorry' => "噗呀...",
	'std_permission_denied_only' => "抱歉，你没有权限哦。只有",
	'std_or_above_can_view' => "及以上等级的用户才能查看这个日志。<br /><br />请查看<a class=faqlink href=faq.php#id22><b>常见问题</b></a>了解更多关于用户等级和权限的信息。<br /><br /><b></p>" .$SITENAME."管理组</b>",
	'head_site_log' => "📜 常规日志",
	...
	'std_permission_denied' => "抱歉！你没有权限。",
	'submit_okay' => "确定",
	...
	'std_delete_poll_confirmation' => "你确定要删除这个投票吗？点击",
