...
(
	...
	'text_second_icon_name_note' => "请不要使用过长的名字，建议在10个字母以内。",
	'text_image_note' => "图片文件的名字。允许使用的字符包括：[a-z]（小写），[0-9]，[_./]。",
	'row_selections' => "选择",
	'text_selections_note' => "如果某个选择未指定，所有选项都将符合此规则。请至少指定一个选择。",
	'row_category_name' => "分类名",
	'text_category_name_note' => "请不要使用过长的名字，建议在10个字母以内。",
	'row_mode' => "模式",
	'text_class_name_note' => "为图片指定class属性值。如果没有，请留空。允许使用的字符：[a-z]（小写），[0-9]，[_]，第一个字符必须是字母。",
	'std_missing_form_data' => "有必填项目未填写。",
	'std_invalid_character_in_filename' => "此文件名包含不合法的字符：",
	'std_must_define_one_selection' => "你必须至少指定一个选择！",
	'std_invalid_mode_id' => "无效的模式id。",
	'row_enable_custom_field' => '启用自定义字段',
	'row_custom_field_display_name' => '自定义字段展示名称',
	'row_custom_field_display' => '自定义字段展示',
	'row_custom_field_display_help' => '使用特殊的标签代表字段的名称和值，例如某字段其 Name 为 artist，则它的名称为：<%artist.label%>，它的值为：<%artist.value%>',
