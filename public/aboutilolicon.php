...
tr($lang_aboutnexus['text_main_version'],ILOLICON_PROJECTNAME,1);
tr($lang_aboutnexus['text_sub_version'],ILOLICON_VERSION_NUMBER,1);
tr($lang_aboutnexus['text_release_date'],ILOLICON_RELEASE_DATE,1);
print ("</table>");
print ("<br /><br />");
end_frame();
begin_frame("<span id=\"nexus\">".$lang_aboutnexus['text_nexus'].ILOLICON_PROJECTNAME."</span>");
...
print (ILOLICON_PROJECTNAME.$lang_aboutnexus['text_translation_note']);
...
print ("<br /><br />");
end_frame();
begin_frame("<span id=\"contact\">".$lang_aboutnexus['text_contact'].ILOLICON_PROJECTNAME."</span>");
print ($lang_aboutnexus['text_contact_note']);
print ("<br /><br /><table class=\"main\" border=\"1\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\">");
tr($lang_aboutnexus['text_web_site'],'<a href="' . ILOLICON_NEXUSPHPURL . '" target="_blank">' . ILOLICON_NEXUSPHPURL . '</a>',1);
print ("</table>");
print ("<br /><br />");
end_frame();
end_main_frame();
